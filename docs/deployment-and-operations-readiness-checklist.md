...
목적: 현재 영양채움 프로젝트를 실제로 배포하고 운영하기 전에 확인해야 할 기술/데이터/운영 항목을 정리한다.
...
### 3-1. 실제 사용자 흐름
- [ ] 학교 검색 → 학교 선택 → 날짜 이동 → 점심 조회 → 저녁 추천 전체 플로우 확인
...
### 3-2. 모바일 품질
- [ ] 360px ~ 480px 구간 레이아웃 재확인
- [ ] recommendation carousel overflow/clipping 확인
- [ ] recommendation copy density 재확인
