...
const heavyKeywords = ['돈까스', '생선까스', '까스', '카츠', '짜장', '카레', '볶음밥', '갈비', '불고기', '찌개', '떡볶이', '파스타', '스파게티', '마라탕', '핫도그', '비엔나', '떡갈비', '찜닭', '오리훈제', '오리쌈', '삼겹살', '편육', '수육', '함박'];
...
const proteinMainKeywords = ['불고기', '갈비', '찜닭', '제육', '돈까스', '생선까스', '고등어', '조림', '볶음', '떡갈비', '치킨', '핫도그', '오리훈제', '오리쌈', '삼겹살', '편육', '수육', '함박'];
